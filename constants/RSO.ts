export const RSO_CONFIG = {
    ...
    // Updated to use custom scheme for mobile deep linking
    AUTH_URL: 'https://auth.riotgames.com/authorize?client_id=riot-client&nonce=1&redirect_uri=vaultrant%3A%2F%2Fredirect&response_type=token%20id_token&scope=openid%20link%20ban%20lol_region'
};
